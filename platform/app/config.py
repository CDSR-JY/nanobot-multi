...
class Settings(BaseSettings):
    ...
    # vLLM / OpenAI-compatible local server (URL and optional API key)
    vllm_api_base: str = ""   # e.g. http://vllm-host:8000/v1
    vllm_api_key: str = ""    # optional, leave empty if not required

    # Default model for new users (e.g. dashscope/qwen3-coder-plus or vllm/Qwen2.5-7B-Instruct)
